#' 
#' @title Predictions for robStepSplitReg Object
#' 
#' @description \code{predict.robStepSplitReg} returns the predictions for a robStepSplitReg object.
#' 
#' @method predict robStepSplitReg
#' 
...
#' 
#' @return The predictions for the robStepSplitReg object.
#' 
#' @export
#' 
